...
public class SoundController : Node
{
    ...
    private AudioStreamPlayer victory_music;
    ...
    public override void _Ready()
    {
        ...
        victory_music = GetNode<AudioStreamPlayer>("Victory_Music");
        victory_music.Stream = GD.Load<AudioStream>("res://Music/20 largo.ogg");
